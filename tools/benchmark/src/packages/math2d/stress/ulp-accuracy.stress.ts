 ...
 *
 * Measures the accuracy of all 14 scalar fdlibm kernel functions by comparing
...
/**
 * Run ULP accuracy for all 14 scalar deterministic kernel functions
 *
 * sinCos is excluded because it returns {sin, cos}, not a scalar.
 * Functions the loaded module does not expose are skipped (the package
 * barrel does not re-export the hyperbolic kernels).
 *
