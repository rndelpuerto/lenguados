...
declare module './base' {
  ...
  namespace Vector2Base {
    ...
    function addScaledVector(base: ReadonlyVector2, scaled: ReadonlyVector2, scale: number): Vector2Base;
    function addScaledVector(base: ReadonlyVector2, scaled: ReadonlyVector2, scale: number, outVector: Vector2Base): Vector2Base;
    ...
    function perpendicular(v: ReadonlyVector2, clockwise: boolean, outVector: Vector2Base): Vector2Base;
    
    function unitPerpendicular(v: ReadonlyVector2, clockwise?: boolean): Vector2Base;
    function unitPerpendicular(v: ReadonlyVector2, clockwise: boolean, outVector: Vector2Base): Vector2Base;
    
    function unitPerpendicularSafe(v: ReadonlyVector2, clockwise?: boolean): Vector2Base;
    function unitPerpendicularSafe(v: ReadonlyVector2, clockwise: boolean, outVector: Vector2Base): Vector2Base;
    ...
    function rotateAround(v: ReadonlyVector2, center: ReadonlyVector2, angle: number, outVector: Vector2Base): Vector2Base;
    
    function rotateAroundCS(v: ReadonlyVector2, center: ReadonlyVector2, c: number, s: number): Vector2Base;
    function rotateAroundCS(v: ReadonlyVector2, center: ReadonlyVector2, c: number, s: number, outVector: Vector2Base): Vector2Base;
    ...
    function projectOnUnit(v: ReadonlyVector2, unitAxis: ReadonlyVector2, outVector: Vector2Base): Vector2Base;
