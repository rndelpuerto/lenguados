...
Vector2Base.prototype.divide = function (v: ReadonlyVector2): any {
 validateNonZeroComponents(v.x, v.y, 'Vector2.divide');
 this.x /= v.x;
 this.y /= v.y;
 return this;
};
...
Vector2Base.prototype.divideScalar = function (s: number): any {
 validateNonZeroDivisor(s, 'Vector2.divideScalar');
 this.x /= s;
 this.y /= s;
 return this;
};
...
Vector2Base.prototype.mod = function (v: ReadonlyVector2): any {
 validateNonZeroComponents(v.x, v.y, 'Vector2.mod');
 this.x %= v.x;
 this.y %= v.y;
 return this;
};
...
Vector2Base.prototype.modScalar = function (s: number): any {
 validateNonZeroDivisor(s, 'Vector2.modScalar');
 this.x %= s;
 this.y %= s;
 return this;
};
