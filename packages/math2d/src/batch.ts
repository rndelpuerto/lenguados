...
export namespace VectorBatch {
  ...
  */
 export function addScalar(vectors: ReadonlyVector2[], scalar: number, out?: Vector2[]): Vector2[] {
  ...
  */
 export function add(a: ReadonlyVector2[], b: ReadonlyVector2[], out?: Vector2[]): Vector2[] {
  ...
  */
 export function scale(vectors: ReadonlyVector2[], scale: number, out?: Vector2[]): Vector2[] {
  const count = vectors.length;
  const result = out || new Array<Vector2>(count);
  ...
  */
 export function normalize(vectors: ReadonlyVector2[], out?: Vector2[]): Vector2[] {
  const count = vectors.length;
  const result = out || new Array<Vector2>(count);
  ...
  * @throws {RangeError} If arrays have different lengths.
  */
 export function dot(a: ReadonlyVector2[], b: ReadonlyVector2[]): number[] {
  if (a.length !== b.length) {
   throw new RangeError(`Array lengths must match: ${a.length} vs ${b.length}`);
  }
  ...
  */
 export function lengths(vectors: ReadonlyVector2[]): number[] {
  const count = vectors.length;
  const result = new Array<number>(count);
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-namespace
export namespace TransformBatch {
 /**
  ...
  */
 export function compose(transforms: ReadonlyTransform2[]): Transform2 {
...
export namespace MatrixBatch {
  ...
  * @throws {Error} If array is empty.
  */
 export function multiplySequence(matrices: ReadonlyMat2[]): Mat2 {
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-namespace
export namespace RotationBatch {
 /**
  ...
  * @throws {Error} If array is empty.
  */
 export function compose(rotations: ReadonlyRot2[]): Rot2 {
