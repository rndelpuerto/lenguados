 ...
 * @returns The same instance, now typed as ReadonlyRotation2.
 *
 * @remarks
...
export class Rotation2 implements Rotation2Like {
 ...
 private static normalizeComponents(cos: number, sin: number): Rotation2Like {
  const magnitude = safeSqrt(cos * cos + sin * sin);
  ...
  * @since 0.1.0
  */
 public static fromVector(direction: ReadonlyVector2Like, out?: Rotation2): Rotation2 {
  assertFinite(direction.x, 'Rotation2.fromVector:x');
  assertFinite(direction.y, 'Rotation2.fromVector:y');
  const x = direction.x;
  const y = direction.y;
  ...
  const inv = 1 / safeSqrt(lengthSquared);
 ...
 public static fromObject(object: Rotation2Like, out?: Rotation2): Rotation2 {
  assertFinite(object.cos, 'Rotation2.fromObject:cos');
  assertFinite(object.sin, 'Rotation2.fromObject:sin');
 ...
 public static fromArray(array: ArrayLike<number>, offset = 0, out?: Rotation2): Rotation2 {
  ...
  assertFinite(array[offset]!, 'Rotation2.fromArray:cos');
  assertFinite(array[offset + 1]!, 'Rotation2.fromArray:sin');
  ...
  * @since 0.9.0
  */
 public static clone(source: ReadonlyRotation2, out?: Rotation2): Rotation2 {
  ...
  * @since 0.9.0
  */
 public static copy(source: ReadonlyRotation2, destination: Rotation2): Rotation2 {
  ...
  * @since 0.9.0
  */
 public static normalize(rotation: ReadonlyRotation2, out?: Rotation2): Rotation2 {
 ...
 public static normalizeSafe(rotation: ReadonlyRotation2, out?: Rotation2): Rotation2 {
  const mag = safeSqrt(rotation.cos * rotation.cos + rotation.sin * rotation.sin);
  const target = Rotation2.ensureOut(out);
  if (isNearZero(mag)) {
   target.cos = 1;
   target.sin = 0;
  ...
  * @since 0.1.0
  */
 public static multiply(a: ReadonlyRotation2, b: ReadonlyRotation2, out?: Rotation2): Rotation2 {
  ...
  * @since 0.1.0
  */
 public static inverse(rotation: ReadonlyRotation2, out?: Rotation2): Rotation2 {
  ...
  * @since 0.1.0
  */
 public static relative(a: ReadonlyRotation2, b: ReadonlyRotation2, out?: Rotation2): Rotation2 {
  const cos = a.cos * b.cos + a.sin * b.sin;
  ...
  * @since 0.1.0
  */
 public static negate(rotation: ReadonlyRotation2, out?: Rotation2): Rotation2 {
  return Rotation2.ensureOut(out).set(rotation.cos, -rotation.sin);
 }
  ...
  * const smooth = Rotation2.smoothLerp(r1, r2, 0.5); // Smooth interpolation
  * ```
  *
  * @category Interpolation
  * @since 0.11.0
  ...
  * @since 0.1.0
  */
 public static exactEquals(a: ReadonlyRotation2, b: ReadonlyRotation2): boolean {
  ...
  * @since 0.1.0
  */
 public static isIdentity(rotation: ReadonlyRotation2, epsilon: number = EPSILON): boolean {
  ...
  * @since 0.9.0
  */
 public static isFinite(rotation: ReadonlyRotation2): boolean {
  ...
  * @since 0.9.0
  */
 public static hasNaN(rotation: ReadonlyRotation2): boolean {
  ...
  * @since 0.1.0
  */
 public static angle(rotation: ReadonlyRotation2): number {
  return DeterministicMath.atan2(rotation.sin, rotation.cos);
 }
  ...
  */
 normalizeSafe(): this {
  const mag = safeSqrt(this.cos * this.cos + this.sin * this.sin);
  if (isNearZero(mag)) {
   this.cos = 1;
   this.sin = 0;
   return this;
  ...
  */
 angle(): number {
  return DeterministicMath.atan2(this.sin, this.cos);
 }
  ...
  * @since 0.1.0
  */
 multiply(other: ReadonlyRotation2): this {
  ...
  * @since 0.1.0
  */
 relativeTo(other: ReadonlyRotation2): this {
  const newCos = this.cos * other.cos + this.sin * other.sin;
  ...
  * @since 0.1.0
  */
 exactEquals(other: ReadonlyRotation2): boolean {
  ...
  * @since 0.9.0
  */
 nearEquals(other: ReadonlyRotation2, epsilon: number = EPSILON): boolean {
  ...
  * @since 0.1.0
  */
 lerp(other: ReadonlyRotation2, t: number): this {
  ...
  * @since 0.9.0
  */
 lerpClamped(other: ReadonlyRotation2, t: number): this {
  ...
  * @since 0.1.0
  */
 smoothLerp(other: ReadonlyRotation2, t: number): this {
  const clamped = saturate(t);
  ...
  * @since 0.1.0
  */
 slerp(other: ReadonlyRotation2, t: number): this {
  const interpolatedAngle = lerpAngle(this.angle(), Rotation2.angle(other), t);
  const result = sinCos(interpolatedAngle);
  this.cos = result.cos;
  this.sin = result.sin;
  ...
  * @since 0.9.0
  */
 slerpClamped(other: ReadonlyRotation2, t: number): this {
