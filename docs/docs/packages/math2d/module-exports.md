...
description: 'Classification decisions and subpath export rationale for @lenguados/math2d'
sidebar_position: 9
---

> Applies the engine-wide [Module Exports & Internals](../../guides/module-exports) framework to `@lenguados/math2d`. For the classification definitions, decision criteria, and build mechanics, see the general guide.
