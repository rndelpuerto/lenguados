...
_Synced from delta spec: `openspec/changes/implement-audit-p1-p2-fixes/specs/audit-p1-fixes` (2026-04-02)_
...
The following constants were removed as part of the P1 audit fixes.

### Removed: ITERATIVE_TOLERANCE constant
...
### Removed: MAX_SAFE_INTEGER_F64 constant
...
### Removed: GOLDEN_RATIO_CONJUGATE constant
